...
export function Header() {
  ...
  return (
    <div className="w-full h-[90px] md:[120px]] bg-white flex items-center justify-center border-solid border-b fixed border-separatorHeader z-50">
      <div className="w-full max-w-[1440px] mx-auto px-8">
        <div className="w-full flex items-center justify-between">
          ...
          {openMenu && (
              <nav className='absolute right-0 top-[5.625rem] w-[50vw] h-[880px] bg-body opacity-90 flex flex-col justify-center'>
